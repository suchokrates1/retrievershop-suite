...
SETTINGS_GROUPS = {
    ...
    "WOO_FEE_P24_FIXED": ("WooCommerce", "bi-bag"),
    ...
    "INPOST_SHOP_LOCKER_A": ("InPost ShipX", "bi-truck"),
    "INPOST_SHOP_LOCKER_B": ("InPost ShipX", "bi-truck"),
    "INPOST_SHOP_LOCKER_C": ("InPost ShipX", "bi-truck"),
    ...
    "CUPS_JOB_TIMEOUT_SECONDS": ("Drukowanie", "bi-printer"),
    "CUPS_JOB_POLL_INTERVAL_SECONDS": ("Drukowanie", "bi-printer"),
    "CUPS_PRINT_MAX_ATTEMPTS": ("Drukowanie", "bi-printer"),
